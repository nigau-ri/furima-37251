class User < ApplicationRecord
  ...
  with_options presence: true do
    ...
    validates :last_name_kana , format: {with: /\A[ァ-ヶ一]+\z/          , message: "Last name kana is invalid. Input full-width katakana characters."}
    validates :first_name_kana, format: {with: /\A[ァ-ヶ一]+\z/          , message: "First name kana is invalid. Input full-width katakana characters."}
