class OrderAddress
  ...
  with_options presence: true do
    ...
    validates :postal_code  , format:{with: /\A[0-9]{3}-[0-9]{4}\z/, message: "is invalid. Include hyphen(-). Input half-width digit"}
    validates :prefecture_id, numericality:{other_than: 0, message: "can't be blank"}
    validates :city     
    validates :addresses
    validates :phone_number , format:{with: /\A[0-9]{10,11}\z/, message: "is invalid. Do not include hyphen(-) Input half-width digit"}
  end
